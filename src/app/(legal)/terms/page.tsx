...
export default function TermsPage() {
  ...
  return (
    <LegalPage title={t('legal.terms_title')}>
      ...
      <LegalSection
        heading={t('legal.terms_subscription')}
        body={t('legal.terms_subscription_text')}
      />
      <LegalSection
        heading={t('legal.terms_cancellation')}
        body={t('legal.terms_cancellation_text')}
      />
      <LegalSection
        heading={t('legal.terms_obligations')}
        body={t('legal.terms_obligations_text')}
      />
      ...
      <LegalSection
        heading={t('legal.terms_data_processing')}
        body={t('legal.terms_data_processing_text')}
      />
      <LegalSection
        heading={t('legal.terms_governing_law')}
        body={t('legal.terms_governing_law_text')}
      />
