...
| `src/app/api/projects/route.ts` | Accept crm_* fields in POST, call onProjectCreated |
| `src/app/api/projects/[id]/route.ts` | Accept crm_* fields in PATCH, return in GET |
